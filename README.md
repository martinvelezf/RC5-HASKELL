...
To run the code:
0. Go to the module location: ```cd scr/modules/RC5 ```
1. Start the interpreter: ```ghci RC5.hs ```
2. To encrypt: ```x = encryption "mar" "123" 10 ```
3. You should get the result as: ```[(-7273264081479612925,-3122923407712225928),(-625
[(-7273264081479612925,-3122923407712225928),(-6256778535516941383,-1835156827000292027),(4196303171515540263,9185718333346717671)] ```
4. The result has type: ``` List[(Int, Int)] ```
5. To decrypt: ``` decrypt x 10 ```
